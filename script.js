...
const dataFileConfig = {
    "Programování": {
        "1. Základní pojmy z algoritmizace a programování": "DataProgramovani.csv",
        "2. Vývoj a druhy programovacích jazyků, vývojové prostředí Visual Studio": "DataVyvojJazyku.csv",
        "3. C# strukturované příkazy větvení, složený příkaz": "DataCSharpVetveni.csv",
        "4. C# strukturované příkazy cyklů": "DataCyklu.csv",
        "5. C# jednoduché datové typy, řetězec; operace": "JednoducheDatove.csv",
        "6. C# strukturované datové typy (kolekce)": "StrukturovaneDatove.csv",
        "7. C# práce se soubory a dialogovými okny": "DataDialog.csv",
        "8. C# Windows Forms Application, grafické ovládací prvky, události": "DataPrvky.csv",
        "9. C# ladění programu, druhy chyb, ošetřování výjimek": "DataChyby.csv",
        "1 0. C# namespace Drawing – nástroje pro programování grafiky": "DataDrawing.csv",
        "1 1. C# metody, jmenné prostory": "DataMetody.csv",
        "1 2. C# základy OOP": "DataOOP.csv",
        "Souhrnné opakování": null
    },
    "Počítačové sítě": {
        "1. Topologie sítí": "DataTopologie.csv",
        "2. Komunikace v síti": "DataKomunikace.csv",
        "3. Pasivní prvky": "DataPasivni.csv",
        "4. Aktivní prvky": "DataAktivni.csv",
        "5. Návrh a realizace sítě": "DataNavrh.csv",
        "6. Bezdrátové technologie": "DataBezdratove.csv",
        "7. Připojení počítače k lokální síti": "DataLokalni.csv",
        "8. Připojení k internetu": "DataInternet.csv",
        "Souhrnné opakování": null
    },
    "Elektronika": {
        "1. Základy digitální techniky": "DataZaklady.csv",
        "2. Integrované polovodičové prvky": "DataPolovodice.csv",
        "3. Řídící jednotka CM-530": "DataCM530.csv",
        "4. Mikroprocesor Arduino": "DataArduino.csv",
        "5. Programování mikroprocesoru Arduino": "DataArduinoProgramovani.csv",
        "6. Počítač": "DataPocitac.csv",
        "7. Procesor": "DataProcesor.csv",
        "8. Základní deska": "DataZakladniDeska.csv",
        "9. Polovodičové paměti": "DataPameti.csv",
        "1 0. Zařízení pro uložení dat": "DataDisky.csv",
        "1 1. Grafický a zobrazovací systém": "DataGrafika.csv",
        "1 2. Digitalizace obrazu a tisk": "DataTisk.csv",
        "1 3. Napájecí zdroje": "DataZdroje.csv",
        "1 4. Diferenciální parametry tranzistoru": "DataTranzistor.csv",
        "1 5. Operační zesilovače": "DataOperacni.csv",
        "1 6. Přenos informací": "DataInformace.csv",
        "1 7. Zesilovače": "DataZesilovace.csv",
        "1 8. Frekvenční filtr typu dolní propust": "DataFFDolni.csv",
        "1 9. Frekvenční filtr typu horní propust": "DataFFHorni.csv",
        "2 0. Sériový a paralelní obvod RL, RC": "DataRLC.csv",
        "Souhrnné opakování": null
    },
    "Automatizace": {
        "1. Regulační obvody": "otazky_tema_1.csv",
        "2. Technické prostředky": "otazky_tema_2.csv",
        "3. Logická zařízení": "otazky_tema_3.csv",
        "4. Druhy výkresů v AT": "otazky_tema_4.csv",
        "5. Elektrické rozvody v průmyslu": "otazky_tema_5.csv",
        "6. Regulační pohony a orgány": "otazky_tema_6.csv",
        "7. Programovatelný automat": "otazky_tema_7.csv",
        "8. Relé impulzní": "otazky_tema_8.csv",
        "9. Převodníky a přizpůsobovací členy": "otazky_tema_9.csv",
        "1 0. Výstavba regulačního obvodu": "otazky_tema_10.csv",
        "1 1. Malé řídící systémy": "otazky_tema_11.csv",
        "1 2. Prvky používané v obvodech AT": "otazky_tema_12.csv",
        "1 3. Senzory - rozdělení": "otazky_tema_13.csv",
        "1 4. Analogové a binární senzory": "otazky_tema_14.csv",
        "1 5. PLC": "otazky_tema_15.csv",
        "1 6. Sekvenční logické obvody": "otazky_tema_16.csv",
        "1 7. Měření neelektrických veličin": "otazky_tema_17.csv",
        "1 8. Typy regulačních obvodů": "otazky_tema_18.csv",
        "1 9. Roboty a jejich aplikace": "otazky_tema_19.csv",
        "2 0. Grafické znázornění stavů": "otazky_tema_20.csv",
        "Souhrnné opakování": null
    },
    "Čeština": {
